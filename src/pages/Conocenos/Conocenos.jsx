...
export const Conocenos = () => {
  ...
  return (
    ...
    <KnouwContainer>
      ...
      <h2>Nuestra Mision <br /> <FaHandshake size={32}/></h2>
      <p>
      ...
      <h2>Nuestra seleccion de libros <br /><FaBookAtlas size={32} /> </h2>
      <p>
      ...
      <h2>Nuestro Equipo  <br /><FaUserFriends size={32}/></h2>
      <p>
      ...
      <h2>Nuestros Valores  <br /><PiMedalFill size={32}/></h2>
      <p>
      ...
      <h2>Cómo Comprar en Nuestra Tienda <br /> <BsFillCartCheckFill size={32}/></h2>
      <p>
